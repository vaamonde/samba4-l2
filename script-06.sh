		...
		then
			if [ "$KERNEL" == "4.4" ]
				then		
					 ...
					 echo -e "Promovendo o servidor SAMBA-4 como Controlador de Domínio" >> $LOG
					 ...
					 echo
					 echo -e "Promoção do Servidor SAMBA4 feita com Sucesso!!!" >> $LOG
					 echo
					 sleep 3
					 ...
					 echo -e "Desabilitando a expiração da senha do usuário Administrator" >> $LOG
					 ...
					 echo -e "Editando o arquivo NAMED.CONF.OPTIONS" >> $LOG
					 ...
					 echo -e "Editando o arquivo NAMED.CONF.LOCAL" >> $LOG
					 ...
					 echo -e "Editando o arquivo APPARMOR.D do DNS" >> $LOG
					 ...
					 echo -e "Editando o arquivo SYSCTL.CONF para o servidor: `hostname`" >> $LOG
					 ...
					 echo -e "Editando o arquivo LIMITS.CONF para o servidor: `hostname`" >> $LOG
